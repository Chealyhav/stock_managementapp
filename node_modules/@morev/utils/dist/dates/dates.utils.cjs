...
var dates_utils_exports = {};
__export(dates_utils_exports, {
  EN_DATETIME_REG_EXP: () => EN_DATETIME_REG_EXP,
  ISO_DATETIME_REG_EXP: () => ISO_DATETIME_REG_EXP,
  RU_DATETIME_REG_EXP: () => RU_DATETIME_REG_EXP,
  createDateFromTokens: () => createDateFromTokens,
  prefixedDateMethodsFactory: () => prefixedDateMethodsFactory
});
module.exports = __toCommonJS(dates_utils_exports);
